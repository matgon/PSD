...
int conecta4ns__getStatus 	(conecta4ns__tMessage playerName, conecta4ns__tBlock* status);
int conecta4ns__insertChip 	(conecta4ns__tMessage playerName, int playerMove, conecta4ns__tBlock* status);
